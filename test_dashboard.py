...
def make_test_db(tmpdir):
    ...
    for url, domain, data in items:
        conn.execute("INSERT INTO processed_data (source_url, source_domain, data) VALUES (?, ?, ?)",
